...
namespace Commons_Automation
{
    public class EditProfile:MainSetup
    {
       ...
       // IWebDriver driver;
        ...
        [FindsBy(How = How.XPath, Using = "//*[@id='edit-field-interests-and-hobbies-0-value']")]
        public IWebElement profileInteresetTxtArea { get; set; }
        ...
        //[FindsBy(How = How.XPath, Using = "//*[@id='edit-field-about-wrapper']/div/div[1]")]
        ...
        [FindsBy(How = How.XPath, Using = "//*[@id='edit-field-about-0-value']")]
        ...
        public void UserProfileSettings(string uploadProfileImage)
        {
            ...
            //AddDescription();
            profileInteresetTxtArea.SendKeys(testDescription);
