...
namespace Commons_Automation
{
    public class UserInfo:MainSetup
    {
       // Idriver driver;
        ...
        [FindsBy(How = How.XPath, Using = "//select[@id='edit-search-api-datasource--3']")]
        public IWebElement TypeDropDownGroupSelected { get; set; }

        [FindsBy(How = How.XPath, Using = "//div[@class='nav__item nav__user-groups']/a/span")]
        public IWebElement myGroupTopMenu { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@class='card-panel alt indent profile-tabs profile__panel']/h2")]
        ...
        [FindsBy(How = How.XPath, Using = "//*[@for='edit-search-api-datasource--3']/parent::div//select/parent::div/input")]
        public IWebElement TypeDropDown { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@for='edit-search-api-datasource--3']/parent::div//input")]
        public IWebElement TypeDropDownPersonSelected { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@for='edit-search-api-datasource--3']/parent::div//select/option[contains(text(),'Any')]")]
        public IWebElement FilterAny { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@for='edit-search-api-datasource--3']/parent::div//select/option[contains(text(),'Comment')]")]
        public IWebElement FilterComment { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@for='edit-search-api-datasource--3']/parent::div//select/option[contains(text(),'Content')]")]
        public IWebElement FilterContent { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@for='edit-search-api-datasource--3']/parent::div//select/option[contains(text(),'Group')]")]
        public IWebElement FilterGroup { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@for='edit-search-api-datasource--3']/parent::div//select/option[contains(text(),'Person')]")]
        public IWebElement FilterPerson { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@for='edit-search-api-datasource--3']/parent::div//select/option[contains(text(),'Resource')]")]
        public IWebElement FilterResourceCenter { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@for='edit-search-api-datasource--3']/parent::div//select/option[contains(text(),'Tag')]")]
       ...
       // [FindsBy(How = How.XPath, Using = "//div[@class='nav__item nav__user-groups']/ul[@id='dropdown--user-groups']/li[4]/a[@href='/groups']")] // "//*[@id='dropdown--user-groups']/li[4]/a")]
        ...
        [FindsBy(How = How.XPath, Using = "//*[contains(@class,'home-page')][1]")]
        ...
        {
            // Pseudocode:
            // 1. Try to check if TypeDropDown is displayed and enabled.
            // 2. If yes, click TypeDropDown.
            // 3. If not, click TypeDropDownPersonSelected as fallback.

            try
            {
                if (TypeDropDown != null && TypeDropDown.Displayed && TypeDropDown.Enabled)
                {
                    TypeDropDown.Click();
                }
                else
                {
                    if (TypeDropDownGroupSelected != null && TypeDropDownGroupSelected.Displayed && TypeDropDownGroupSelected.Enabled)
                    {
                        TypeDropDownGroupSelected.Click();
                    }
                }
            }
            catch (NoSuchElementException)
            {
                // Fallback if TypeDropDown is not found at all
                if (TypeDropDownGroupSelected != null && TypeDropDownGroupSelected.Displayed && TypeDropDownGroupSelected.Enabled)
                {
                    TypeDropDownGroupSelected.Click();
                }
        ...
        public void ClickOnTypeDropDownPersonSelected()
        {
            TypeDropDownPersonSelected.Click();
            driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromMilliseconds(1000);
        }
        ...
        public void UserMenu()
        {
            ...
            WebDriverExtensions.WaitUntilElementClickable(driver, allMyGroups, 5); 
