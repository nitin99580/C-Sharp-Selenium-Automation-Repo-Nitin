   ...
   public class NotificationSettings:MainSetup
    {
        ...
        public void Masqueradestudent(string StudentName)
        {
            ...
            txtDisplayName.SendKeys(StudentName); 
            //FilterBtn.Click();
            PageServices.ClickButtonByJavaScript(driver, FilterBtn);
            Thread.Sleep(3000);
            //StudentEditBtn.Click();
            //StudentEditBtnCSS.Click();
            //Actions actions = new Actions(driver);
            //actions.MoveToElement(StudentEditBtnCSS).Build().Perform();
            PageServices.ScrollIntoElement(driver, StudentEditBtnCSS);
            StudentEditBtnCSS.Click();
            MasqueradeBtnCSS.Click();
        ...
        [FindsBy(How = How.XPath, Using = "//*[@class='views-field views-field-field-name']//span")]
        public IList<IWebElement> StudentName { get; set; }

        [FindsBy(How = How.CssSelector, Using = "input#edit-field-name-value")]
        public IWebElement InputSearchFiled { get; set; }       

        [FindsBy(How = How.XPath, Using = "//*[@class='dropbutton-arrow']/parent::button")]
        public IList< IWebElement> StudentEditBtn { get; set; }

        [FindsBy(How = How.XPath, Using = "//a[text()='Edit']")]
        public IList<IWebElement> SelectEditBtn { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@class='dropbutton-action']/a")]
        public IList<IWebElement> StudentEditBtnClick { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@class='dropbutton-arrow']/parent::button")]
        public IWebElement StudentEditBtnCSS { get; set; }

        [FindsBy(How = How.XPath, Using = "//a[contains(text(),'Masquerade')]")]
       ...
       // [FindsBy(How = How.XPath, Using = "//*[@id='views-exposed-form-directory-all']/ul/li/div[1]/a[4]")]
        ...
        [FindsBy(How = How.XPath, Using = "//a[contains(@class,'dropdown-button circle user-picture')]")]
        ...
        [FindsBy(How = How.XPath, Using = "//*[@class='card-panel alt indent profile-tabs profile__panel']")]
        public IWebElement AlumniInfoText { get; set; }


        [FindsBy(How = How.XPath, Using = "//div[@class='card-panel alt indent profile-tabs profile__panel']/span[@class='placard']")]
        ...
        [FindsBy(How = How.XPath, Using = "//*[@alt='ASC Proofreader']/parent::a")]
        ...
        public void OpenPeoplePage()
        {
            ...
            //NineIcon.Click();
            Thread.Sleep(4000);
            PageServices.ClickButtonByJavaScript(driver, NineIcon);
            Thread.Sleep(2000);
            //PeopleText.Click();
            PageServices.ClickButtonByJavaScript(driver, PeopleText);
            Thread.Sleep(3000);
            PageServices.WaitForPageToCompletelyLoaded(driver, 60);
            PeopleFilter.Click();
            Thread.Sleep(2000);
            //UniversityRoleDropdown.Click();
            PageServices.ClickButtonByJavaScript(driver, UniversityRoleDropdown);
            Thread.Sleep(2000);
            //PageServices.WaitForPageToCompletelyLoaded(driver, 60);
            //Thread.Sleep(3000);
        ...
        public void AssignAlumni_WithRole(string Role)
        {
            ...
            VerifyAlumniIcon(userNAme, Role);

            test.Log(Status.Pass, "Assigned Alumni Role");
        }
        public void VerifyAlumniIcon(string userName, string Role)
        {
            OpenPeoplePage();
            Thread.Sleep(2000);
            if (Role == "Student")
            ...
            PageServices.ClickButtonByJavaScript(driver, FilterBtn);
            Thread.Sleep(3000);
            PageServices.ScrollIntoElement(driver, DropdownMasq[0]);
            PageServices.ClickButtonByJavaScript(driver, DropdownMasq[0]);
            //DropdownMasq[0].Click();
            Thread.Sleep(1000);
            //DropdownMasqBtn[0].Click();            
            PageServices.ClickButtonByJavaScript(driver, DropdownMasqBtn[0]);
