  ...
  public class SearchPage:MainSetup
    {
       ...
       public string BannerText = "This is an archived post, older than two years and the information included in this post may no longer be valid. Comments are disabled.";
        ...
        [FindsBy(How = How.CssSelector, Using = "input[id^= 'edit-search-api-fulltext']")]
        //[FindsBy(How = How.XPath, Using = "//*[@id='edit-search-api-fulltext--3']")]
        ...
        [FindsBy(How = How.XPath, Using = "//*[contains(@class,'search-result-item')]")]
        ...
        //[FindsBy(How = How.XPath, Using = "//div[@id='expand-collapse-0']/div/p[3]")]
        ...
        [FindsBy(How = How.XPath, Using = "(//div[@class='entity-intro__main']//a/h2)[1]")]
        public IWebElement verifyGroupTitle { get; set; }

        [FindsBy(How = How.XPath, Using = "(//div[@class='entity-intro__description']/p)[1]")]
        ...
        public void ValidatePageNavigationOnSearchPage()
        {
            ...
            {
                //btnNextPage.Click();
                PageServices.ClickButtonByJavaScript(driver, btnNextPage);
                Thread.Sleep(500); 
                //btnPreviousPage.Click();
                PageServices.ClickButtonByJavaScript(driver, btnPreviousPage);
                Thread.Sleep(500);
                //btnLastPage.Click();
                PageServices.ClickButtonByJavaScript(driver, btnLastPage);
                Thread.Sleep(500); 
                //btnFirstPage.Click();
                PageServices.ClickButtonByJavaScript(driver, btnFirstPage);
            }
        }
