    ...
    public class UserGroupContent:MainSetup
    {
      //  Idriver driver;
       // UserInfo userInfo;
        ...
        By verificationMsgCSS = By.XPath("//*[@aria-label='Status message']");
        ...
        [FindsBy(How = How.XPath, Using = "(//*[contains(@class,'dropbutton-action')])[1]/a")]
        ...
        [FindsBy(How = How.XPath, Using = "(//*[@class='dropbutton-action'])[1]/a")]
        public IWebElement EditContent { get; set; }

        [FindsBy(How = How.XPath, Using = "//*[@id='edit-delete']")]
        ...
        [FindsBy(How = How.XPath, Using = "//*[contains(@class,'table__header')]/h4")]
