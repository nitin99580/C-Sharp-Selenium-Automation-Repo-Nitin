...
namespace Commons_Automation
{
    public class ConversationGroup:MainSetup
    {
       ...
       // [FindsBy(How = How.XPath, Using = "//nav[@id='navigation']/div/div[@class='nav__item nav__user-groups']/a[contains(@href,'group')]")]
        ...
        [FindsBy(How = How.XPath, Using = "//*[@id='views-exposed-form-content-pages-page-1']/ul/li/div[1]/a")]
        ...
        [FindsBy(How = How.CssSelector, Using = "div.collapsible-body > div > div:nth-child(1) > div > div > ul > li>span")]
        ...
        public void verifyConversationGrpItems()
        {
           ...
           //cmGrps.OpenJoinedGroup();
            ...
            Thread.Sleep(5000);
            PageServices.ScrollIntoElement(driver, filterByMonth);
            ...
            Thread.Sleep(5000);
            PageServices.ScrollIntoElement(driver, videoFilter);
...
/*
            ...
            */
            ...
            PageServices.ClickButtonByJavaScript(driver, SchoolTopMenuLink);
            grpActivity.lnkPersonalCommons.Click();
