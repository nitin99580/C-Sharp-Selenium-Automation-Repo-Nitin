      ...
      //  [Ignore("SSO is not setup")]
       ...
       // [Ignore("SSO Not Setup")]
        ...
        public void Direct_InvalidLogin()
        {
            ...
            string expectedErrorUsrNm = "Username or email not recognized, please re-enter or contact the Service Desk.";
        ...
        public void PrivateMessage__SendAndRecieve()
        {
            ...
            if (environmentSetup == "QA1" )
            {
                ...
                recipientName = "pranjal saxena"; //"Anitha Malathkar (Admin)";
            }

            if (environmentSetup == "AWS")
            {
                // recipientName = "Matt Drew";
                recipientName = "psaxenaadmin";    //"Anitha Admin";
            }
            ...
            {
                recipientName = "pranjal saxena";      // "Anitha Admin"; //"Matthew Drew Admin";
            }
        ...
        public void Report_Messages()
        {
            ...
            if (environmentSetup == "QA1" )
            {
                recipientName = "Prashanthi Vatsavai";   //"Mcurtis Admin"; //"Anitha Malathkar (Admin)";

                recepeintName2 = "pranjal saxena";  //"psaxenaadmin";
                IIndSOSUser = "psaxenaadmin";
                IIndSSOPassword = "psaxenaadmin";
            ...
            {
                recipientName = "Matt Drew NU Product Management"; // "mdrewadmin"; // "Matthew Drew Admin";

                recepeintName2 = "pranjal saxena";  //  "pranjal saxena";           // "amalathkaradmin";

                IIndSOSUser = "psaxenaadmin";            // "amalathkaradmin";
                IIndSSOPassword = "psaxenaadmin";           // "amalathkaradmin";
        ...
        public void PrivateMessage_LeaveConversation()
        {
            ...
            if (environmentSetup == "QA1")
            {
                ...
                recipientName1 = "pranjal saxena";      //"Anitha Malathkar (Admin)";
                //recipientName2 = "Katia Nyysti";
                //recipientName3 = "Priya Narahari";
            }
            if (environmentSetup == "AWS")
            {
                // recipientName = "Matt Drew";
                recipientName1 = "pranjal saxena"; // "Anitha Admin";
            }

            if (environmentSetup == "QA2")
            {
                recipientName1 = "pranjal saxena";    //"Anitha Admin"; //nonSSOUser
        ...
        public void Viewing_ArchivedCheckbox()
        {
            ...
            Thread.Sleep(2000);
            PageServices.ClickButtonByJavaScript(driver, cmGrps.EditPostLink);
            //grpActivity.contextualLink2.Click();
            Thread.Sleep(3000);
        ...
        public void GroupInviteFilter()
        {
            ...
            cmGrps.JoinAndOpenGroup(cmGrps.ConversationGroupName);
            personalCommons.ClickOnPersonalCommons();
            cmGrps.OpenJoinedGroup_SetStewardRole(cmGrps.ConversationGroupName, "pranjal saxena");
            cmGrps.GroupIcon.Click();
        ...
        public void Verify_WYSIWYG_EmbededImagePost()
        {
            ...
            cmGrps.JoinAndOpenGroup(cmGrps.ConversationGroupName);
            myGroups.CommonsHome.Click();
            cmGrps.WYSIWYGPost(uploadProfileImage, "Library Insider");
            userInfo.Logout();
            test.Log(Status.Pass, "Test case has been completed");
...
*/
        ...
        public void JFKLawSchool()
        {
            ...
            personalCommons.ClickOnPersonalCommons();
            Thread.Sleep(1000);
            conversationGroup.verifySchoolIconandCount("SUS Community Forum", "Shawn Harrelson");
            userInfo.Logout();
