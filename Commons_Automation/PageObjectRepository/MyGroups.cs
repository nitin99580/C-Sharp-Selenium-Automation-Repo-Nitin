...
namespace Commons_Automation
{
    ...
    public class MyGroups:MainSetup
    {
       ...
       // IWebDriver driver;
        ...
        string DefGrpCentFrTeachLearn = "NU Business Incubator"; // "Graduate Studies Support Center"; //"Center for Teaching and Learning"; // Default Group center-for-teaching-and-learning
