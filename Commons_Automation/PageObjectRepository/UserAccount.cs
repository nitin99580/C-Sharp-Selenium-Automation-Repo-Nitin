   ...
   public class UserAccount:MainSetup
    {
       ...
       // [FindsBy(How = How.XPath, Using = "//div[@id='block-views-block-profile-block-1']//div[@class='card-panel alt indent entity__intro profile-tabs']")]
        //[FindsBy(How = How.XPath, Using = "//*[@id='block-views-block-profile-block-1']/div[2]/div/div[2]/div[1]/div[1]/text()[3]")]
        [FindsBy(How = How.XPath, Using = "//*[@class='user-picture__large']")]
        ...
        [FindsBy(How = How.XPath, Using = "(//div[@class='post__meta']/a)[1]")]
